        ...
        function (a, c) {
          let d = (function a(c, d) {
              ...
              for (let k of i) {
                let i = e(k);
                if (i) {
                  if (d && ("route-group" === i.type || "parallel-route" === i.type))
                    throw Object.defineProperty(
                      new b.InvariantError(
            ...
            j = f.map(({ paramName: a, paramType: b }) => ({ paramName: a, paramType: b }));
          return (
            !(function (a, b, c, d) {
...
Read more at https://nextjs.org/docs/messages/missing-root-layout-tags"
  ...
  (a) => {
    ...
    let ah = ["authors", "tags"],
      ...
      ak = ["emails", "phoneNumbers", "faxNumbers", "alternateLocale", "audio", "videos"];
    function al(a, b, c) {
      let d = Z(a);
      if (!d) return d;
      let e = [];
    ...
    let am = {
      ...
      an = async (a, b, c, d, e) => {
        ...
        for (let b of (f = a && "type" in a ? a.type : void 0) && f in am ? am[f].concat(ak) : ak)
          if (b in a && "url" !== b) {
            let c = a[b];
            g[b] = c ? Y(c) : null;
          }
    ...
    async function aw(a, b, c, d) {
      return a
        ? { url: at("string" == typeof a || a instanceof URL ? a : a.url, b, await c, d) }
        : null;
    }
    let ax = async (a, b, c, d) => {
      ...
      aA = (a) =>
        a ? { basic: az(a), googleBot: "string" != typeof a ? az(a.googleBot) : null } : null,
      ...
      aF = async (a, b, c, d) =>
        a
          ? {
              appId: a.appId,
              appArgument: a.appArgument ? at(a.appArgument, b, await c, d) : void 0,
            }
          : null,
      aG = (a) => (a ? { appId: a.appId, admins: Z(a.admins) } : null),
      aH = async (a, b, c, d) => ({
        previous: (null == a ? void 0 : a.previous) ? at(a.previous, b, await c, d) : null,
    ...
    async function aS(
      ...
      let j = structuredClone(d),
        k = aQ((null == c ? void 0 : c.metadataBase) !== void 0 ? c.metadataBase : d.metadataBase);
      for (let d in c)
        switch (d) {
          case "title":
...
Read more: https://nextjs.org/docs/app/api-reference/functions/generate-viewport`);
    ...
    async function a7(a, b, c, d) {
      ...
      return (function (a, b, c, d) {
        ...
        if (e) {
          ...
          if (
            (!g &&
              (a2(e.title) ? (b.title = e.title) : a.title && a2(a.title) && (b.title = a.title)),
    ...
    let bc = new Set(Object.values({ NOT_FOUND: 404, FORBIDDEN: 403, UNAUTHORIZED: 401 }));
    function bd(a) {
        ...
        function ({
          ...
          async function o() {
            ...
            return await bj(a, m, i, e, d, h, f).catch((b) => {
              if (bg(b)) throw b;
              return !f && bd(b) ? bl(a, m, i, e, d, h).catch(() => null) : null;
            });
          }
          function p() {
            let b = Promise.all([bj(a, m, i, e, d, h, f), bn(a, i, e, h, f)]).then(() => null);
            return g
          ...
          return (
            ...
            {
              Viewport: function () {
                return (0, W.jsx)(bh.ViewportBoundary, { children: (0, W.jsx)(n, {}) });
              },
              Metadata: function () {
                return g
                  ? (0, W.jsx)("div", {
                  ...
                  : (0, W.jsx)(bh.MetadataBoundary, { children: (0, W.jsx)(o, {}) });
              },
              MetadataOutlet: p,
            }
          );
...
Original Message: ${d}`);
        ...
        })(a, (null == b ? void 0 : b.route) ?? "unknown route", bI.SegmentCollection);
      }
    }
    function bK(a) {
      let b = a.f;
    ...
    async function bL(a, b, e, f, g, h, j) {
      ...
      for (let [a, c] of (k.set("/_tree", p), k.set("/_full", b), await Promise.all(n)))
        k.set(a, c);
      return k;
    }
    async function bM(a, b, c, e, f, g) {
      ...
      let h = await (0, bx.createFromReadableStream)(bU((0, by.streamFromBuffer)(a)), {
          findSourceMapURL: d,
          serverConsumerManifest: e,
        }),
        i = bK(h);
    ...
    async function bP({
      ...
      let k = await (0, bx.createFromReadableStream)(bU((0, by.streamFromBuffer)(b)), {
          findSourceMapURL: d,
          serverConsumerManifest: c,
        }),
        l = bK(k);
      ...
      let { buildId: m, flightRouterState: n, seedData: o, head: p } = l,
        ...
        s = (function a(b, c, d, e, f, g, h, i, j, k) {
          ...
          j ||
            (null !== f &&
              i.push((0, bz.waitAtLeastOneReactRenderTask)().then(() => bQ(d, e, f[0], h, s, g))));
          let t = c[0];
          return (
            "string" == typeof t
              ? ((l = t), (m = null))
      ...
      (i
        ? g.push((0, bz.waitAtLeastOneReactRenderTask)().then(() => bR(n, m, f, o, p, r, e)))
        : g.push((0, bz.waitAtLeastOneReactRenderTask)().then(() => bQ(m, f, p, bA, r, e))),
        h());
      let t = { tree: s, staleTime: f };
      return (m && (t.buildId = m), t);
    }
    async function bQ(a, b, d, e, f, g) {
      let h = { rsc: d, isPartial: await bT(d, g), staleTime: b, varyParams: f };
      a && (h.buildId = a);
    ...
    async function bS(a, b, c, d, e) {
      ...
      let i = null !== d ? d[0] : null,
        j = null !== d ? d[4] : null,
        k = null !== j ? bv(j) : null,
        l = { rsc: i, isPartial: null === i || (await bT(i, e)), staleTime: c, varyParams: k };
    ...
    a.s(["collectPrefetchHints", 0, bM, "collectSegmentData", 0, bL], 34373);
    var bV = a.i(21751);
    let bW = () => {};
    function bX(a) {
              ...
              globalThis.fetch = (function (a, { workAsyncStorage: b, workUnitAsyncStorage: c }) {
                let d = async function (d, e) {
                  ...
                  let r = (0, aL.getTracer)().trace(
                    k ? aM.NextNodeServerSpan.internalFetch : aM.AppRenderSpan.fetch,
                    {
                      hideSpan: m,
                    ...
                    async () => {
                      ...
                      switch (y) {
                        ...
                        case "force-cache":
                          (void 0 === u || 0 === u) &&
                            ((B = "fetchCache = force-cache"), (l = bV.INFINITE_CACHE));
                      }
                      if (
                        (void 0 === l
                          ? "default-cache" !== y || z
                            ? "default-no-store" === y
                              ...
                              : z
                                ...
                                : K
                                  ? ((l = 0), (B = "auto no cache"))
                                  : ((B = "auto cache"), (l = c ? c.revalidate : bV.INFINITE_CACHE))
                            : ((l = bV.INFINITE_CACHE), (B = "fetchCache = default-cache"))
                          : B || (B = `revalidate: ${l}`),
                          ...
                          return a(d, k)
                            .then(async (a) => {
                              if (
                                ...
                                let b = l >= bV.INFINITE_CACHE ? bV.CACHE_ONE_YEAR_SECONDS : l,
                                  c = M
                                    ? {
                                        fetchCache: !0,
                                        fetchUrl: i,
                                ...
                                switch (null == p ? void 0 : p.type) {
                                  ...
                                  case "generate-static-params":
                                  case void 0:
                                    return b1(o, a, g, c, N, h, b, d, Q, r("signal"));
                                }
                              }
                              return (await Q(), a);
                            })
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0zgvpt1._.js.map
